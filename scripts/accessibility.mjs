...
const routes = ['/', '/how-it-works', '/solutions', '/why-bundlebob', '/resources', '/resources/when-systems-disagree', '/resources/wip-review', '/resources/mapping-first', '/about', '/contact', '/system'];
