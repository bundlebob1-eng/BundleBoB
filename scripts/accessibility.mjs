...
const routes = ['/forward-deployed-engineering', '/services/ai-solutions', '/services/custom-software', '/services/integrations', '/construction', '/services', '/approach', '/', '/how-it-works', '/solutions', '/why-bundlebob', '/resources', '/resources/when-systems-disagree', '/resources/wip-review', '/resources/mapping-first', '/about', '/contact', '/system'];
